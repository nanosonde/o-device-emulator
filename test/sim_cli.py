...
from device_emulator.devices import olt_profile
...
_DEVICE_CLASSES = {"ap": EapDevice, "switch": SwitchDevice, "gateway": GatewayDevice, "olt": OltDevice}
# The OLT default must be one of olt_profile.VALID_MODELS or the controller
# flags the device incompatible and refuses adoption.
_DEFAULT_MODELS = {
    "ap": "EAP245",
    "switch": "TL-SG3210",
    "gateway": "ER605",
    "olt": olt_profile.DEFAULT_MODEL,
}

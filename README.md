...
implemented and validated end-to-end for **access points, switches, and
gateways** (each reported as compatible, no warning). Enable it via the
`adopt:` block in the config. The discovery and adoption flows are validated
against both controller v5.15 and v6.2. See
